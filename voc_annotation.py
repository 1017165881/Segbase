...
if __name__ == '__main__':
    # 标签图像文件夹路径
    label_folder = 'D:/PythonProjects/deeplabv3-plus-mobilenetv2-main/deeplabv3-plus-main/VOCdevkit/VOC2007/SegmentationClassB'
    output_folder = 'D:/PythonProjects/deeplabv3-plus-mobilenetv2-main/deeplabv3-plus-main/VOCdevkit/VOC2007/SegmentationClass'
    ...
    for filename in os.listdir(label_folder):
        if filename.endswith('.png') or filename.endswith('.jpg'):  # 根据你的文件格式选择
            # 加载标签图像
            label_image = cv2.imread(os.path.join(label_folder, filename), cv2.IMREAD_GRAYSCALE)
